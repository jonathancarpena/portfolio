...
function AllBlogs({ blogs, tags }) {
    ...
    return (
        <>
            <SEO title="Blog Posts | Jonathan Carpena - Full Stack Software Engineer" description="My name is Jonathan Carpena and this is a place where I document my thoughts (write blog posts) about topics ranging from my career/journey as a Software Engineer to my personal book recommendations" />
