        ...
        <motion.footer
            ...
            <motion.section
                ...
                <ul className='flex flex-col space-y-5'>
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/jonathan-carpena-582873196/" target="_blank" rel="noopener noreferrer" className='flex items-end  text-lg md:text-xl space-x-2 md:space-x-5s'>
                            <FiLinkedin className=' text-[3rem] h-[40px] md:h-[45px]' />
                            <p className='flex-1 flex items-center font-semibold bg-lighter text-accent-500 px-2 h-[45px] rounded-md'>/jonathancarpena</p>
                        </a>
                    </li>
                    <li className='hidden md:block'>
                        <Popover long={true} className='w-max flex items-end  text-xl space-x-2 md:space-x-5s '>
