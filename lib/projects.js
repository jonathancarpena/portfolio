const Projects = [
    {
        ...
        description: "A web app created for client that displays information about their company and products. Application also features a content managing system and ordering system.",
        tools: [
            'react', 'redux', 'tailwindCSS',
            'mongoDB', 'express', 'node.js'
        ],
        github: 'https://github.com/jonathancarpena/nathans-meal-prep',
        link: 'https://nathansmealprep.netlify.app/',
    ...
    },
    {
        ...
        description: "A client's web application that showcases their lash artist business. Application implements a booking system, a content management system, and a user-interface that reflects the personality of the client/brand.",
        tools: [
            'react', 'redux', 'tailwindCSS',
            'mongoDB', 'express', 'node.js'
        ],
        github: 'https://github.com/jonathancarpena/jolina-lashes',
        link: 'https://jolinalashes.netlify.app/',
    ...
    },
    {
        ...
        description: "A data visualizing tool uses the Reddit API that analyzes Reddit User's comments/posts activity and displays them on a user-friendly chart. Additionally, the application also analyzes and identifies Subreddit's most optimal time of the week to post.",
        tools: [
    ...
    },
    {
        ...
        link: 'https://jonathancarpena-v1.github.io/',
