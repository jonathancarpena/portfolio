const Projects = [
    {
        ...
        description: "A meal prep business web application developed for client to boost their branding. This full-stack MERN application features an admin-only content management system and a customer ordering system.",
    ...
    },
    {
        ...
        description: "A lash artist services web application developed for a client to reach user's online. This full-stack MERN application features a customer-booking system, and a admin-only content management system.",
    ...
    },
    {
        ...
        description: "A data visualizing tool that utilizes the Reddit API. The application analyzes Reddit user's comments/posts activity and displays them on user-friendly charts. Additionally, the application also identifies a Subreddit's most optimal time of the week to post.",
